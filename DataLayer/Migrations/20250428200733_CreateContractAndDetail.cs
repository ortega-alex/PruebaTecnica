...
{
    /// <inheritdoc />
    public partial class CreateContractAndDetail : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisconuntPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractDetails_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractDetails_ServiceId",
                table: "ContractDetails",
                column: "ServiceId");
